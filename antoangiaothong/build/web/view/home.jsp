...
<body>
    <nav class="navbar">
        <div class="header-top">
            ...
            <details class="user-menu">
                <summary class="user-icon">Xin chào, <span class="user-name">Nguyễn Văn A</span> 👤</summary>
                <ul>
    ...
    <main class="main-content">
        ...
        <section class="stats-section">
            <h2 class="section-title">Thống kê Giao thông</h2>
            <div class="stats-container">
                <canvas id="trafficChart" width="600" height="300"></canvas>
                <div class="stats-details">
                    <p>Thống kê vi phạm giao thông trong tháng 6/2025: <strong>150 trường hợp</strong>.</p>
                    <p>Tỷ lệ xử lý: <strong>60%</strong> | Số phản ánh: <strong>120 trường hợp</strong>.</p>
                    <p>Số vi phạm đã thanh toán: <strong>90 trường hợp</strong>.</p>
                </div>
            </div>
        </section>
    </main>
    ...
    <script>
        // Biểu đồ thống kê giao thông
        const ctx = document.getElementById('trafficChart').getContext('2d');
        const trafficChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Vi phạm', 'Phản ánh', 'Xử lý', 'Thanh toán'],
                datasets: [{
                    label: 'Số lượng',
                    data: [150, 120, 90, 90],
