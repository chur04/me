  ...
  <div>
    ...
    <section id="luat-phap" class="py-5 bg-light">
      <div class="container text-center slide-in">
        ...
        <a href="/view/law-info.jsp" class="btn btn-custom mt-4">Xem Chi Tiết Luật</a>
      </div>
    </section>
          ...
          <div class="col-md-6">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text fw-bold text-danger">- Nguyễn Văn A, Hà Nội</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text fw-bold text-danger">- Trần Thị B, TP.HCM</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="tin-tuc" class="py-5">
      <div class="container text-center slide-in">
        ...
        <a href="/view/news.jsp" class="btn btn-custom mt-4">Xem Tất Cả Tin Tức</a>
      </div>
    </section>
    ...
    <section id="chien-dich" class="py-5">
      <div class="container text-center slide-in">
        ...
        <a href="/view/campaigns.jsp" class="btn btn-custom mt-4">Xem Thêm Chiến Dịch</a>
      </div>
    </section>
    ...
    <section id="su-kien" class="py-5">
      <div class="container text-center slide-in">
        ...
        <a href="/view/events.jsp" class="btn btn-custom mt-4">Xem Thêm Sự Kiện</a>
      </div>
    </section>
    ...
    <section class="py-5 bg-light">
      <div class="container text-center slide-in">
        ...
        <a href="/view/gallery.jsp" class="btn btn-custom mt-4">Xem Thêm Hình Ảnh</a>
      </div>
    </section>
    ...
    <section class="py-5">
      <div class="container text-center slide-in">
        ...
        <a href="/view/faq.jsp" class="btn btn-custom mt-4">Xem Thêm Câu Hỏi</a>
      </div>
    </section>
